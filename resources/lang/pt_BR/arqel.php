...
return [
    ...
    'fields_advanced' => [
        ...
        'builder_drag_reorder' => 'Arrastar para reordenar o bloco :number',
        'builder_expand_block' => 'Expandir bloco :number',
        'builder_collapse_block' => 'Recolher bloco :number',
        'builder_move_block_up' => 'Mover bloco :number para cima',
        'builder_move_block_down' => 'Mover bloco :number para baixo',
        'builder_clone_block' => 'Clonar bloco :number',
        'keyvalue_key' => 'Chave',
